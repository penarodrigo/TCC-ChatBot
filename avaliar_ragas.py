...
# A inicialização global em rag_gemini_improved.py será acionada aqui.
from rag_gemini_improved import rag_system_instance, config
...
def run_ragas_evaluation():
    ...
    if not rag_system_instance or not config:
        print("Erro: Sistema RAG ou configuração não inicializados. Verifique rag_gemini_improved.py.")
        return
    ...
    # LLM que o RAGAS usará para julgar (ex: para faithfulness, answer_correctness)
